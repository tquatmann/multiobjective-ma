...
module main
	...
	[] (!is_running) & (num_finished <= 2) & (f_j1 = 0) & (f_j2 = 0) & (f_j3 = 0) -> 1: (r_j1' = 1) & (r_j2' = 1) & (r_j3' = 1);
	[] (!is_running) & (num_finished <= 2) & (f_j1 = 0) & (f_j2 = 0) & (f_j4 = 0) -> 1: (r_j1' = 1) & (r_j2' = 1) & (r_j4' = 1);
	[] (!is_running) & (num_finished <= 2) & (f_j1 = 0) & (f_j2 = 0) & (f_j5 = 0) -> 1: (r_j1' = 1) & (r_j2' = 1) & (r_j5' = 1);
	[] (!is_running) & (num_finished <= 2) & (f_j1 = 0) & (f_j3 = 0) & (f_j4 = 0) -> 1: (r_j1' = 1) & (r_j3' = 1) & (r_j4' = 1);
	[] (!is_running) & (num_finished <= 2) & (f_j1 = 0) & (f_j3 = 0) & (f_j5 = 0) -> 1: (r_j1' = 1) & (r_j3' = 1) & (r_j5' = 1);
	[] (!is_running) & (num_finished <= 2) & (f_j1 = 0) & (f_j4 = 0) & (f_j5 = 0) -> 1: (r_j1' = 1) & (r_j4' = 1) & (r_j5' = 1);
	[] (!is_running) & (num_finished <= 2) & (f_j2 = 0) & (f_j3 = 0) & (f_j4 = 0) -> 1: (r_j2' = 1) & (r_j3' = 1) & (r_j4' = 1);
	[] (!is_running) & (num_finished <= 2) & (f_j2 = 0) & (f_j3 = 0) & (f_j5 = 0) -> 1: (r_j2' = 1) & (r_j3' = 1) & (r_j5' = 1);
	[] (!is_running) & (num_finished <= 2) & (f_j2 = 0) & (f_j4 = 0) & (f_j5 = 0) -> 1: (r_j2' = 1) & (r_j4' = 1) & (r_j5' = 1);
	[] (!is_running) & (num_finished <= 2) & (f_j3 = 0) & (f_j4 = 0) & (f_j5 = 0) -> 1: (r_j3' = 1) & (r_j4' = 1) & (r_j5' = 1);
endmodule
init
	r_j1 = 0 &
	r_j2 = 0 &
